...
var markersArray = [];
	...
	//for (i=0;i<=3;i++)
		...
		var grey = 'https://lh6.googleusercontent.com/-C2V2frP5Low/UQvmiV65lLI/AAAAAAAABuw/U6BhBjM7dDQ/s800/grey-dot.png'
		...
		else if(dataTab.getValue(i, 3)=="IV"){
		marker = new google.maps.Marker({position: latlng, title: title, map: map, icon: green});
		}
		
		else{
		marker = new google.maps.Marker({position: latlng, title: title, map: map, icon: grey});
		}
